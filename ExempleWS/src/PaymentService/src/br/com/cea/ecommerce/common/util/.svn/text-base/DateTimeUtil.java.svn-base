...
public class DateTimeUtil {
	...
	public static final String PATTERN_DATE_PT_WITHOUT_SLASH = "ddMMyyyy";
	
	public static final String PATTERN_DATE_EN_WITHOUT_SLASH = "yyyyMMdd";
	
	public static final String PATTERN_TIME_PT = "HHmmss";
